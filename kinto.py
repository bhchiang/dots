...
terminals = ["kinto-gui.py", "gnome-terminal", "konsole", "io.elementary.terminal", "terminator", "sakura",
             "guake", "tilda", "xterm", "eterm", "kitty", "alacritty", "mate-terminal", "tilix", "xfce4-terminal", "hyper"]
terminals = [term.casefold() for term in terminals]
termStr = "|".join(str(x) for x in terminals)

# Use for browser specific hotkeys
browsers = ["Chromium", "Chromium-browser", "Google-chrome",
            "microsoft-edge-dev", "microsoft-edge", "Epiphany", "Firefox", "Discord"]
...
define_keymap(None, {
    # Default SL - Launch Application Menu (gnome/kde)
    K("RC-Space"): K("Alt-F1"),
    ...
    K("RC-H"): K("Super-h"),
    # Default not-xfce4 - Cmd Tab - App Switching Default
    K("M-Tab"): pass_through_key,
    # Default not-xfce4 - Cmd Tab - App Switching Default
    K("RC-Tab"): K("M-Tab"),
    # Default not-xfce4 - Cmd Tab - App Switching Default
...
define_keymap(re.compile("Sublime_text", re.IGNORECASE), {
    ...
    # Default - cancel find_all_under
    K("M-f3"): pass_through_key,
    ...
    # cancel sort_lines case_s false
